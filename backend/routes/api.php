...
Route::middleware(['auth:sanctum', 'portal:client'])->group(function () {
    ...
    Route::put('/client/cart', [CartController::class, 'update']);
    Route::post('/client/cart/items', [CartController::class, 'addItem']);
    Route::put('/client/cart/items/{item}', [CartController::class, 'updateItem']);
    Route::delete('/client/cart/items/{item}', [CartController::class, 'removeItem']);
    Route::delete('/client/cart', [CartController::class, 'clear']);
