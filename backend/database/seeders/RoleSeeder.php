    ...
    public function run(): void
    {
        ...
        $assignments = [
            ...
            'responsable-agence' => array_merge(
                ...
                $p('orders', ['consulter', 'creer', 'modifier', 'supprimer', 'valider', 'refuser']),
            ...
            'responsable-departement' => array_merge(
                ...
                $p('invoices', ['consulter', 'creer', 'modifier', 'imprimer', 'annuler', 'exporter']),
                $p('stats', ['consulter']),
                $p('courses', ['consulter', 'creer', 'modifier']),
            ...
            'commercial' => array_merge(
                ...
                $p('stats', ['consulter']),
                $p('orders', ['consulter', 'creer', 'modifier', 'soumettre']),
                $p('reports', ['consulter', 'exporter']),
            ...
            'caissier' => array_merge(
                ...
                $p('orders', ['consulter', 'valider', 'refuser']),
                $p('reports', ['consulter']),
