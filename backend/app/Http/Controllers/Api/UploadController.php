...
use App\Http\Requests\Api\UploadProofRequest;
...
class UploadController extends Controller
{
    ...
    #[OA\Post(
        ...
        summary: 'Uploader une preuve de paiement (image ou PDF)',
        tags: ['Uploads'],
        security: [['sanctum' => []]],
        requestBody: new OA\RequestBody(
            required: true,
    ...
    public function storeProof(UploadProofRequest $request): JsonResponse
    {
