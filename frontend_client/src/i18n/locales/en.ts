export default {
  ...
  auth: {
    ...
    resetLinkIncomplete: 'The reset link is incomplete or invalid.',
  ...
  account: {
    ...
    profile: 'My Profile',
      ...
      missingField: 'Please fill in first name and last name.',
    overview: 'Overview',
    totalOrders: 'Orders',
    ...
    deletedRejected: 'Invoice deleted.',
    deleteRejectedError: 'Deletion failed.',
  ...
  academy: {
    ...
    months: 'months',
    hours: 'hours',
    formationDetails: 'About the course',
    playVideo: 'Play presentation video',
  },
  status: {
    pending: 'Pending',
    validated: 'Validated',
